...
const TEXT_CARDS: readonly Card[] = [
  {
...
const CODE_CARDS: readonly Card[] = [
  {
    title: 'Explain Code',
...
@Component({
  ...
  styleUrl: './chatgpt-assistant.component.css',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class ChatGPTAssistantComponent implements OnInit {
  private readonly seoService = inject(SeoService)

  readonly textCards = TEXT_CARDS
  readonly codeCards = CODE_CARDS

  ngOnInit(): void {
    this.seoService.setMetaTitle('ChatGPT Assistant for Writing and Coding')
